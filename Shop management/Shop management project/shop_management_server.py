...
class Server:
        ...
        while True:
            try:
                ...
                if action == 'login':
                    ...
                    with self.lock_inventory:
                        self.get_products(client_socket_rev)
                elif action == 'add_employee':
                    with self.lock_employees:
                        self.add_employee_to_database(*params)
                    client_socket_rev.send('Employee added successfully.'.encode())
    ...
    def get_products(self, client_socket_rev):
        with self.conn_inventory:
            ...
            client_socket_rev.sendall(products_str.encode())
